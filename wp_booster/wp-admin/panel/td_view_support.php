...
<div class="about-wrap td-admin-wrap">
    ...
    <div style="margin-top: 26px;">
        ...
        <div class="td-admin-box-text td-admin-box-three">
            ...
            <p>Our online documentation will give you important information about the theme. This is an exceptional resource to start discovering the theme’s true potential.</p>
