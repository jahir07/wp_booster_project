<div class="wrap about-wrap">
    ...
    <h2 class="nav-tab-wrapper">
        <a href="admin.php?page=td_theme_welcome" class="nav-tab <?php if(isset($_GET['page']) and $_GET['page'] == 'td_theme_welcome') { echo 'nav-tab-active'; }?> ">
            <?php _e( 'Welcome' ); ?>
        </a><a href="admin.php?page=td_theme_demos" class="nav-tab <?php if(isset($_GET['page']) and $_GET['page'] == 'td_theme_demos') { echo 'nav-tab-active'; }?>">
