...
//    }
	...
	static function on_ajax_login() {
		 ...
		 */
		if ((td_util::is_mobile_theme() === true && td_util::get_option('tds_login_mobile') == 'hide') || (td_util::is_mobile_theme() === false && td_util::get_option('tds_login_sign_in_widget') != 'show')) {
			exit();
		}
